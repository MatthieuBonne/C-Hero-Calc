...
const std::string VERSION = "4.7.5.1a";
const std::string REPLAYCODE = "475a"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
...
enum SkillType {
    ...
    AOELIN,// Linearly increasing AoE
    ...
    DEATHREF,//Reflect stored damage on death
    ...
    ANTIREFLECT,// Reduces reflect damage dealt to this unit/due to this unit, depending on reflect type by X%
