...
const std::string VERSION = "4.7.3.0g";
const std::string REPLAYCODE = "473g"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
