...
const std::string VERSION = "4.7.0.2test_broken_res_4";
const std::string REPLAYCODE = "470f"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
