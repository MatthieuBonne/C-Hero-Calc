...
const std::string VERSION = "4.6.2.3c";
const std::string REPLAYCODE = "462c"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
