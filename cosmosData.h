...
const std::string VERSION = "4.6.0.1b";
const std::string REPLAYCODE = "460b"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
...
enum SkillType {
    ...
    AOEEXP,// Exponentially increasing AoE
