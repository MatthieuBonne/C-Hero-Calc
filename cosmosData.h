...
const std::string VERSION = "4.3.2.1c";
const std::string REPLAYCODE = "432c"; //4-number/letter sequence at the start of replay, that helps identify calc version. First 4 characters are responsible for tournament info in replay.
